      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <header className="mx-auto mb-8 max-w-2xl text-center sm:mb-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-xs leading-5 text-white/40 sm:text-sm">
            Saisissez les informations utilisées lors de votre
            inscription afin d'annuler votre billet SiloCamp.
          </p>
        ...
        <section className="mx-auto max-w-xl overflow-hidden rounded-2xl border border-[#C8A45D]/15 bg-[#0D0D0D]">
          ...
          <div className="px-5 py-7 sm:px-7 sm:py-8">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="group flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-[#C8A45D] px-5 text-xs font-semibold text-[#0A0A0A] transition-all duration-200 hover:bg-[#D8B96E] disabled:cursor-not-allowed disabled:opacity-50"
              >
          ...
          <div className="border-t border-white/[0.06] px-5 py-4 sm:px-7">
            ...
            <p className="text-center text-[9px] leading-4 text-white/25">
              L'annulation de votre billet est définitive.
              Une réservation annulée ne pourra plus être utilisée
              pour accéder au Camp International Silo 2026.
            </p>
